...
const char* TRIGGER_URL = "http://192.168.1.90:8000/api/scan-trigger/";
const char* UPLOAD_URL  = "http://192.168.1.90:8000/api/upload-template/";
const char* MATCH_URL   = "http://192.168.1.90:8000/api/match-template/";
